...
export default function SearchInput<T extends FieldValues>({
  ...
  return (
    <Input
      ...
      inputStyle={`bg-transparent rounded-[10px] border border-gray-30 focus:outline-none focus:border-purple-50 ${iconPosition === 'left' ? 'pl-[49px] pr-[15px]' : 'pr-[49px] pl-[15px]'} py-[9px]`}
      type='text'
    >
      <img
