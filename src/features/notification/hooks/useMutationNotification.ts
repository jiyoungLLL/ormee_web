...
import { putNotificationAsRead } from '../api/notification.api';
import { QUERY_KEYS } from '@/hooks/queries/queryKeys';
import { Notification, NotificationFilterType } from '../notification.types';

type PutNotificationAsReadParams = {
...
export const useMarkNotificationAsRead = () => {
  ...
  return useMutation({
    ...
    onMutate: async ({ notificationId, lectureId, currentFilter }: PutNotificationAsReadParams) => {
