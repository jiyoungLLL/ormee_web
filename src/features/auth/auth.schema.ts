...
export const phoneNumberSchema = z
  ...
  .refine(
    ...
    {
      message: AUTH_ERROR_MESSAGES.INVALID_PHONE_NUMBER,
    },
  );
...
export const signupSchema = z
  .object({
    id: z
      .string()
      .min(4, { message: AUTH_ERROR_MESSAGES.INVALID_ID_MIN_LENGTH })
      .max(15, { message: AUTH_ERROR_MESSAGES.INVALID_ID_MAXLENGTH })
      .regex(/^[a-z0-9_]+$/, { message: AUTH_ERROR_MESSAGES.INVALID_ID_SPECIAL_CHARACTER }),
    password: z
      .string()
      .min(8, { message: AUTH_ERROR_MESSAGES.INVALID_PASSWORD_MIN_LENGTH })
      .max(16, { message: AUTH_ERROR_MESSAGES.INVALID_PASSWORD_MAX_LENGTH })
      .refine(
        (password) => {
        ...
        { message: AUTH_ERROR_MESSAGES.INVALID_PASSWORD_SPECIAL_CHARACTER },
      ),
    ...
    name: z
      .string()
      .min(1, { message: AUTH_ERROR_MESSAGES.EMPTY_NAME })
      .regex(/^[가-힣]+$/, { message: AUTH_ERROR_MESSAGES.INVALID_NAME }),
    teacherName: z
      .string()
...
export const accountRecoverySchema = z.object({
  name: z.string().min(1, { message: AUTH_ERROR_MESSAGES.EMPTY_NAME }),
  phoneNumber: phoneNumberSchema,
});
